...
namespace TransDep_AdminApp.Trucks
{
    public class Container : Truck
    {
        ...
        //TODO: ---------------------------------
        public Container(string _id, string _driverId, string _name, int _carryingCapacity, int _usefulVolume, int _capacity, int _parkingSpot, bool _availability = true)
